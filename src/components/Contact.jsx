    ...
    <section id="contact" className="px-4 py-20 max-w-6xl mx-auto">
      ...
      <div className="bg-slate-800 rounded-xl p-8 sm:p-10 border border-slate-700/50 max-w-xl mx-auto text-center">
        <p className="text-slate-300 leading-relaxed mb-8">
          ...
          want to say hello — I&apos;d love to hear from you. The best way to
          reach me is through LinkedIn or email.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="mailto:byubraden26@gmail.com"
            className="inline-flex items-center gap-2 px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-full transition-colors"
          >
            <HiEnvelope size={18} />
            Send an Email
          </a>
